...
import { mockSummaryCard } from "./components/mockSummaryCard.js";
import { StudyUnitList } from "./components/StudyUnitList.js";
import { SummaryCardView } from "./components/SummaryCardView.js";
...
export function App() {
  return (
    <main style={{ fontFamily: "sans-serif", padding: 32, maxWidth: 860, margin: "0 auto" }}>
      ...
      <section>
        <h2>요약 카드 (mock 데이터)</h2>
        <SummaryCardView card={mockSummaryCard} />
      </section>
